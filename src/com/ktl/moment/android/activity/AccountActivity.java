...
public class AccountActivity extends BaseActivity implements OnLoginListener,
		OnLoginToRegisterListener, OnForgetListener, OnCloseLoginListener,
		OnRegisterListener, OnCloseRegisterListener, OnBackToLoginListener,
		OnNextListener, OnBackToRegisterListener, OnNextToProfileListener,
	...
	private void switchFragmentByTag(String selectedTag, int moveFlag) {
		...
		attachFragment(R.id.account_content_cantainer,
	...
	private void fragmentSwitchAnim(int moveFlag) {
		...
		case ANIMATION_MOVE_RIGHT:
			fragmentTransaction.setCustomAnimations(R.anim.left_in,
					R.anim.right_out);// param1 login,param2 logout
			break;
	...
	public void closeLoginClick() {
		// TODO Auto-generated method stub
		switchFragmentByTag(C.Account.FRAGMENT_START, ANIMATION_ALPHA_IN);// login
																			// to
																			// register
	}
